...
Original file is located at
    https://colab.research.google.com/drive/1grSUXtESRf2wiWeE2niauG75z0ZDbWbK
"""
...
def create_rfm_df(df):
    rfm_df = df.groupby(by='customer_id',as_index=False).agg({
        'order_date':'max', # get last date order
        'order_id':'nunique',
        'total_price':'sum'
    })
...
with st.sidebar:
    ...
    start_date, end_date = st.date_input(
        label='Period', min_value=min_date,
        max_value=max_date,
...
colors = ["red", "lightblue", "lightblue","lightblue","lightblue"]
